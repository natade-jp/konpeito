...
{
	test_count = 0;
	const testLUP = function(x, epsilon) {
		test_count++;
		const tolerance = epsilon ? epsilon : 0.1;
		const X = $(x);
		const LUP = X.lup();
...
{
	test_count = 0;
	const testQR = function(x, epsilon) {
		test_count++;
		const tolerance = epsilon ? epsilon : 0.1;
		const X = $(x);
		const QR = X.qr();
...
{
	test_count = 0;
	const testTRI = function(x, epsilon) {
		test_count++;
		const tolerance = epsilon ? epsilon : 0.1;
		const X = $(x);
...
{
	test_count = 0;
	const testEIG = function(x, epsilon) {
		test_count++;
		const tolerance = epsilon ? epsilon : 0.1;
		const X = $(x);
		const VD = X.eig();
...
{
	test_count = 0;
	const testSVD = function(x, epsilon) {
		test_count++;
		const tolerance = epsilon ? epsilon : 0.1;
		const X = $(x);
		const USV = X.svd();
...
{
	test_count = 0;
	const testINV = function(x, epsilon) {
		test_count++;
		const tolerance = epsilon ? epsilon : 0.1;
		const X = $(x);
		const invX = X.inv();
...
{
	test_count = 0;
	const testPINV = function(x, epsilon) {
		test_count++;
		const tolerance = epsilon ? epsilon : 0.1;
		const X = $(x);
		const Y = X.pinv().pinv();
